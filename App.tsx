...
const TEXTS = {
  DE: {
    ...
    keyboardHint: "1-4 = Antwort wählen • Leertaste = Weiter • F = Vollbild"
  },
  EN: {
    welcome: "Welcome",
    ...
    newsTitle: "BREAKING NEWS",
    keyboardHint: "1-4 = Pick answer • Space = Continue • F = Fullscreen"
  }
};
                 ...
                 <div className="flex flex-col h-full relative z-20">
                    ...
                    <div className="flex-1 p-4 md:p-8 overflow-y-auto flex flex-col items-center justify-center">
                        ...
                        <div className="mt-8 flex flex-col items-center gap-3">
                            <Button onClick={() => handleAnswer(-1)} className="bg-white/10 hover:bg-white/20 text-white border border-white/20 backdrop-blur-md" size="sm">{t.skip}</Button>
                            <div className="text-white/60 text-xs md:text-sm font-bold uppercase tracking-widest bg-white/5 border border-white/10 rounded-full px-4 py-2 backdrop-blur-md flex items-center gap-2 shadow-inner">
